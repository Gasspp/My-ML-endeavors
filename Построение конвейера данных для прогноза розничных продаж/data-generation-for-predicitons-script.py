...
len_uniques = get_valid_int(
    "Введите количество уникальных значений (до 5000), не превышающее длину данных: ",
    min_val=1,
...
# Конструируем признак, отображающий кол-во продаж в предыдущий день
df['sales_lag_1'] = df.sales.shift(1)

# Скользящее среднее интервалом в неделю 
...
df.to_csv('sales_data_for_prediction.csv', index=False)
